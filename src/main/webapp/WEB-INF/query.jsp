...
<body>
	...
	<center style="margin: 20px 0;">
		<a href="http://211.87.234.13:8888/"><img alt="mima"
	...
	<div id="container" style="width: 100%; border-top: 2px black solid;">
		...
		<div style="margin: 50px;">
			...
			<c:forEach var="item" items="${queryItemList }">
				<div class="block"
					style="width: 60%; margin: 15px 0; border-bottom: 1px solid #DDDEE2;">
					<div class="row">
						<strong style="color: #1E90FF;">${item.id } </strong>
					</div>
					<div class="row" style="color: #444; margin: 5px 0;">
						<span>${item.text }</span>
					</div>
				</div>
			</c:forEach>
